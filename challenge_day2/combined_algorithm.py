...
observation1 = ('10:06:05', 33, '2024-04-20', 29049, 1904, 'Nadee', 24, 'b+c+a*e')
observation2 = ('10:07:23', 65, '2024-04-03', 44119, 3546, 'Mies', 16, 'e*d')
observation3 = ('12:04:24', 9, '2024-02-20', 14525, 5721, 'Jelle', 84, 'a*b')
...
# The tests from tests.py use different data and are no longer needed.
